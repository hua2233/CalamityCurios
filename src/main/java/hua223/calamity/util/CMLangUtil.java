...
//    }
    ...
    public static void batchColorTexts(List<Component> tooltips, ChatFormatting formatting, String name, int... entry) {
        Style style = Style.EMPTY.withColor(formatting);
        for (int e : entry) tooltips.add(CMLangUtil.getTranslatable(name, e).setStyle(style));
    }
}
