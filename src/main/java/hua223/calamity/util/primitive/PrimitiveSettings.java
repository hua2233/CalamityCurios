...
public final class PrimitiveSettings {
    ...
    public final Function<Float, Vector4i> vertexColorFunction;
    ...
    public PrimitiveSettings(Function<Float, Float> vertexWidthFunction,
                             Function<Float, Vector4i> vertexColorFunction,
    ...
    public void addArgument(Vec3 position, Vector4i color, Vec2 uv, float widthCorrectionFactor) {
