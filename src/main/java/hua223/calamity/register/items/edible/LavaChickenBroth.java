...
//1.19.2 No new bosses have been updated, and there will be no handling for creature drops temporarily
public class LavaChickenBroth extends Item {
    ...
    @ApplyGlobalLoot
    public void onGetChestLoot(ChestLootContext context) {
