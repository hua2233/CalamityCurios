...
public class Excelsus extends SwordItem implements IDataPackResponse {
    ...
    public boolean hurtEnemy(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        CalamityHelp.addIfDoesNotExist(target, 30, 0, effect);
        ...
        if (attacker instanceof ServerPlayer player) {
            ...
            hurt.hurt(CalamityDamageSource.source(DamageTypes.MAGIC, player), 6);

            if (hurt.isAlive()) {
                CalamityHelp.addIfDoesNotExist(hurt, 40, 0, effect);
