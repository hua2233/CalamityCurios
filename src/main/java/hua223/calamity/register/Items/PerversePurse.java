...
public class PerversePurse extends Item {
    ...
    @Override
    public @NotNull InteractionResult interactLivingEntity(@NotNull ItemStack stack, Player player, @NotNull LivingEntity interactionTarget,
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> tooltips, @NotNull TooltipFlag advanced) {
        CMLangUtil.batchColorTexts(tooltips, ChatFormatting.YELLOW, "perverse_purse", 1, 2, 3);
