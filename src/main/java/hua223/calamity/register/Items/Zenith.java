...
public final class Zenith extends SwordItem {
    public Zenith(int attackDamageModifier, float attackSpeedModifier, Properties properties) {
    ...
    @Override
    @OnlyIn(Dist.CLIENT)
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level pLevel, List<Component> tooltip, @NotNull TooltipFlag advanced) {
        tooltip.add(CMLangUtil.getTranslatable("zenith").withStyle(ChatFormatting.DARK_PURPLE));
    }
}
