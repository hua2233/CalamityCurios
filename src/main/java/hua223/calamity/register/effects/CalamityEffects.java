...
public class CalamityEffects {
    ...
    public static final RegistryObject<MobEffect> FUNGAL_CLUMP = EFFECTS.register("fungal_clump",
        () -> new FungalClump(MobEffectCategory.NEUTRAL,  0x44BBFD));

    public static final RegistryObject<MobEffect> HOLY_FLAMES = EFFECTS.register("holy_flames",
        () -> new HolyFlames(MobEffectCategory.HARMFUL,  16755200));

    public static final RegistryObject<MobEffect> DIVINE_BLESS = EFFECTS.register("divine_bless",
        () -> new CalamityEffect(MobEffectCategory.BENEFICIAL,  16755200));

    public static final RegistryObject<MobEffect> LIFE_OPPRESS = EFFECTS.register("life_oppress",
        () -> new LifeOppress(MobEffectCategory.HARMFUL,  11141120));
