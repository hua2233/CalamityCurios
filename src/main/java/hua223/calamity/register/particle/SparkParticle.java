...
public class SparkParticle extends SingleTexturedParticle {
    ...
    protected final Vector4i initialColor;
    ...
    public void tick() {
        ...
        RenderUtil.interpolateToTransparent(initialColor, (float) Math.pow(lifetimeCompletion, 3d), color);
    ...
    public void render(VertexConsumer buffer, Camera camera, float partialTick) {
        ...
        Quaternionf quaternion = new Quaternionf().rotateZ(RenderUtil.rotLerpRadians(partialTick, oRoll, roll));
    ...
    public static class SparkType extends FastParticleType<SparkOptions> {
        ...
        protected SparkOptions getInstance(Object... o) {
            return new SparkOptions((Float) o[0], (Integer) o[1], new Vector4i((Integer) o[2], (Integer) o[3], (Integer) o[4], (Integer) o[5]));
        }
    ...
    public static class SparkOptions implements ParticleOptions {
        ...
        public SparkOptions(float scale, int lifetime, Vector4i color) {
            this.scale = scale;
            this.lifetime = lifetime;
            this.color = color;
        }
        ...
        public void writeToNetwork(FriendlyByteBuf buffer) {
            getType().toNetwork(buffer, scale, color.x(), color.y(), color.z(), color.w());
        }

        @Override
        public String writeToString() {
            return getType().toCommandString(scale, lifetime, color.x(), color.y(), color.z(), color.w());
        }
    }
}
