...
public class Pulse extends SingleTexturedParticle {
    ...
    public Pulse(ClientLevel level, double x, double y, double z, Vector4i color, double speedX, double speedY,
        ...
        lifetime = lifeTime;
        this.squish = squish;
        this.rotation = new Quaternionf().rotateZ(rotation);
        hasPhysics = false;
    }
    ...
    public void tick() {
        ...
        color.set((int) (baseColor.x * opacity), (int) (baseColor.y * opacity),
            (int) (baseColor.z * opacity), (int) (baseColor.w * opacity));
    }
    ...
    public static class PulseType extends FastParticleType<PulseOptions> {
        ...
        protected PulseOptions getInstance(Object... o) {
            return new PulseOptions((float) o[0], (float) o[1], (float) o[2], (float) o[3], (float) o[4],
                new Vector4i((int) o[5], (int) o[6], (int) o[7], (int) o[8]), (int) o[9]);
        }
    ...
    public static class PulseOptions implements ParticleOptions {
        ...
        public PulseOptions(float originalScale, float finalScale, float rotation, float squishX,
                            float squishY, Vector4i color, int lifetime) {
            this.color = color;
        ...
        @Override
        @OnlyIn(Dist.CLIENT)
        public @NotNull PulseType getType() {
