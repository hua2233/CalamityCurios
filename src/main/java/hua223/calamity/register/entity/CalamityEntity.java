...
public class CalamityEntity {
    ...
    public static final RegistryObject<EntityType<Nebula>> NEBULA = ENTITIES.register("nebula",
        () -> EntityType.Builder.of(Nebula::new, MobCategory.MISC).sized(0.25f, 0.25f)
    ...
    public static final RegistryObject<EntityType<DreamCatcherHook>> DREAM_CATCHER_HOOK = ENTITIES.register("dream_catcher_hook",
        () -> EntityType.Builder.of(DreamCatcherHook::new, MobCategory.MISC).sized(.5f, .5f)
            .clientTrackingRange(16).updateInterval(2)
            .noSummon().noSave().setShouldReceiveVelocityUpdates(false).build("dream_catcher_hook"));
    ...
    public static final RegistryObject<EntityType<SummonedAncientKnight>> SAK = ENTITIES.register("summoned_keeper",
        () -> EntityType.Builder.of(SummonedAncientKnight::new, MobCategory.MONSTER).sized(0.85F, 2.3F)
            .clientTrackingRange(64).noSave().setShouldReceiveVelocityUpdates(false).build("summoned_keeper"));

    public static final RegistryObject<EntityType<DemonGate>> DEMON_GATE = ENTITIES.register("demon_gate",
        () -> EntityType.Builder.of(DemonGate::new, MobCategory.MISC).sized(1.65F + 0.185F * 6, 0.2f)
            .clientTrackingRange(32).noSave().setShouldReceiveVelocityUpdates(false).build("demon_gate"));
