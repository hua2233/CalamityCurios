...
public class UniverseSplitterHugeBeam extends Entity {
            ...
            if (tickCount >= 10) {
                if (scopeBox == null) {
                    ...
                    for (int i = 0; i < 20; i++) {
                        ...
                        BlockPos pos = new BlockPos((int) (x + xOffset), yPos, (int) (z + zOffset));
    ...
    public static class Render extends EntityRenderer<UniverseSplitterHugeBeam> {
        ...
        @Override
        public @NotNull ResourceLocation getTextureLocation(@NotNull UniverseSplitterHugeBeam universeSplitterHugeBeam) {
            return CalamityCurios.ModResource("textures/entity/universe_splitter_huge_beam_mid.png");
        }

        @Override
        public boolean shouldRender(UniverseSplitterHugeBeam livingEntity, @NotNull Frustum camera, double pCamX, double pCamY, double pCamZ) {
