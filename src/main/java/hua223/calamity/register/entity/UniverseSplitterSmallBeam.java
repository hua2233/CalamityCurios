...
public class UniverseSplitterSmallBeam extends Entity implements IEntityAdditionalSpawnData {
    ...
    public static class Render extends EntityRenderer<UniverseSplitterSmallBeam> {
        ...
        @Override
        public void render(UniverseSplitterSmallBeam entity, float entityYaw, float partialTick,
                           @NotNull PoseStack pose, @NotNull MultiBufferSource buffer, int packedLight) {
            if (entity.rotationOld != 0) {
                pose.pushPose();
                pose.mulPose(Axis.ZP.rotation(RenderUtil.rotLerpRadians(partialTick, entity.rotationOld, entity.rotation)));
        ...
        @Override
        public boolean shouldRender(@NotNull UniverseSplitterSmallBeam pLivingEntity, @NotNull Frustum pCamera, double pCamX, double pCamY, double pCamZ) {
            return true;
        }

        @Override
        public @NotNull ResourceLocation getTextureLocation(@NotNull UniverseSplitterSmallBeam universeSplitterSmallBeam) {
