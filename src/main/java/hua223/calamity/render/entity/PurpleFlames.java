...
public class PurpleFlames {
    private static TextureAtlasSprite flames0;
    private static TextureAtlasSprite flames1;
    ...
    public static void renderFlame(RenderLivingEvent.Post<?, ?> event) {
        ...
        if (entity.calamity$GodSlayerFlames) {
            ...
            for (PoseStack.Pose pose = matrixStack.last(); f3 > 0.0F; ++i) {
                TextureAtlasSprite sprite2 = i % 2 == 0 ? flames0 : flames1;
    ...
    public static void afterSpriteStitch(TextureAtlas atlas) {
        flames0 = atlas.getSprite(CalamityCurios.ModResource("block/fire_0"));
        flames1 = atlas.getSprite(CalamityCurios.ModResource("block/fire_1"));
    }
