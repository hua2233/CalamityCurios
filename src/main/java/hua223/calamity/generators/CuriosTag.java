...
public class CuriosTag extends JsonCodecProvider<CuriosTag.CuriosTagData> {
    public CuriosTag(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, existingFileHelper, "calamity_curios", JsonOps.INSTANCE,
    ...
    private static Map<ResourceLocation, CuriosTagData> getTagEnters() {
        ...
        factory.accept("head", List.of(
            ...
            SACRIFICES_MASK, FUNGAL_CLUMP, SILVAS_CROWN));

        factory.accept("necklace", List.of(
            YHARIM_GIFT, COUNTER_SCARF, BLOODY_WORM_SCARF,
            EVASION_SCARF, SCIONS_CURIO, DEADSHOT_BROOCH,
            CHAOS_STONE, VEXATION_NECKLACE, SAND_SHARK,
            REGENATOR, REAPER, LIFE_JELLY, BEE, AMBROSIAL_AMPOULE,
            BLAZING_CORE, EVOLUTION, GLADIATOR_LOCKET,
            RAIDERS_TALISMAN, VENERATED_LOCKET, WYRM_TOOTH_NECKLACE,
            FORESEE_ORB, HOLY_MOONLIGHT, AZURE_ABYSS_TALISMAN));
        ...
        factory.accept("charm", List.of(
            ...
            BLOOM_STONE, INFECTED_JEWEL, DEIFIC_AMULET, GRAVISTAR_SABATON,
            AERO_STONE, ANGEL_TREADS, VAMPIRIC_TALISMAN, STAR_CHARM,
            MOON_WALKERS, VOID_STRIDERS, SERAPH_TRACERS));

        factory.accept("back", List.of(
            WARBANNER_SUN, NIHILITY_QUIVER, PLANEBREAKERS_POUCH,
        ...
        factory.accept("spellbook", List.of(ETERNITY));
